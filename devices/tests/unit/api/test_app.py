...
from devices.api import app as api_app
from devices.api import config as api_config
from devices.api import hooks
from devices.tests import base
...
class TestAppConfig(base.BaseTestCase):
    ...
    def test_get_pecan_config(self):
        ...
        self.assertIsInstance(config_d['hooks'][0], hooks.DBHook)
